...
renderSpaceShip(SpaceshipsAll[0], SpaceshipsAll[1]);
...
function renderSpaceShip(oneShip,oneShip1) { 
spaceShipsList.innerHTML= `<li>
...
<article class="spaceship">
  <h3 class="spaceship__title">${oneShip1.name}</h3>

  <ul class="spaceship__colorslist">
    <li class="spaceship__color" style="background-color: #${oneShip1.colors[0]};"></li>
    <li class="spaceship__color" style="background-color: #${oneShip1.colors[1]};"></li>
    <li class="spaceship__color" style="background-color: #${oneShip1.colors[2]};"></li>
    <li class="spaceship__color" style="background-color: #${oneShip1.colors[3]};"></li>
    <li class="spaceship__color" style="background-color: #${oneShip1.colors[4]};"></li>
  </ul>
